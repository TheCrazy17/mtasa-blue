...
public:
    ...
    // Restores the whole vehicle mesh to its pristine (pre-deform/stretch) shape.
    virtual bool         ResetMeshDeform() = 0;
    ...
    virtual bool         ResetComponentMeshDeform(const SString& vehicleComponent) = 0;
};
