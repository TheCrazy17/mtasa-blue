...
IMPLEMENT_ENUM_BEGIN(WeaponProperty::Enum)
...
IMPLEMENT_ENUM_BEGIN(ObjectProperty::Enum)
...
IMPLEMENT_ENUM_BEGIN(ObjectGroupPhysicalProperties::Modifiable)
...
IMPLEMENT_ENUM_BEGIN(ObjectGroupPhysicalProperties::DamageEffect)
...
IMPLEMENT_ENUM_BEGIN(ObjectGroupPhysicalProperties::CollisionResponse)
...
IMPLEMENT_ENUM_BEGIN(ObjectGroupPhysicalProperties::FxType)
...
IMPLEMENT_ENUM_BEGIN(ObjectGroupPhysicalProperties::BreakMode)
...
IMPLEMENT_ENUM_BEGIN(VehicleDummies::Enum)
...
ADD_ENUM(VehicleExtraType::EXTRA_WHEEL, "extraWheel")
ADD_ENUM(VehicleExtraType::SPOILER, "spoiler")
ADD_ENUM(VehicleExtraType::GEAR_INDICATOR, "gearIndicator")
ADD_ENUM(VehicleExtraType::SPEED_GAUGE, "speedGauge")
ADD_ENUM(VehicleExtraType::RPM_GAUGE, "rpmGauge")
...
ADD_ENUM(VehicleExtraType::ROTATE_DOOR, "rotateDoor")
ADD_ENUM(VehicleExtraType::SLIDE_DOOR, "slideDoor")
ADD_ENUM(VehicleExtraType::CONVERTIBLE_ROOF, "convertibleRoof")
ADD_ENUM(VehicleExtraType::ROLLBACK_BED, "rollbackBed")
ADD_ENUM(VehicleExtraType::HEADLIGHT, "headlight")
ADD_ENUM(VehicleExtraType::TAIL_LIGHT, "tailLight")
ADD_ENUM(VehicleExtraType::BRAKE_LIGHT, "brakeLight")
ADD_ENUM(VehicleExtraType::REVERSE_LIGHT, "reverseLight")
ADD_ENUM(VehicleExtraType::SIDE_LIGHT, "sideLight")
ADD_ENUM(VehicleExtraType::FOG_LIGHT, "fogLight")
ADD_ENUM(VehicleExtraType::DRL, "drl")
ADD_ENUM(VehicleExtraType::STROBE_LIGHT, "strobeLight")
ADD_ENUM(VehicleExtraType::SPOTLIGHT, "spotlight")
ADD_ENUM(VehicleExtraType::INDICATOR_LEFT, "indicatorLeft")
ADD_ENUM(VehicleExtraType::INDICATOR_RIGHT, "indicatorRight")
ADD_ENUM(VehicleExtraType::STT_LIGHT_LEFT, "sttLightLeft")
ADD_ENUM(VehicleExtraType::STT_LIGHT_RIGHT, "sttLightRight")
ADD_ENUM(VehicleExtraType::NABRAKE_LIGHT_LEFT, "nabrakeLightLeft")
ADD_ENUM(VehicleExtraType::NABRAKE_LIGHT_RIGHT, "nabrakeLightRight")
ADD_ENUM(VehicleExtraType::LED_ENGINE_ON, "ledEngineOn")
ADD_ENUM(VehicleExtraType::LED_ENGINE_BROKEN, "ledEngineBroken")
ADD_ENUM(VehicleExtraType::LED_FOG_LIGHT, "ledFogLight")
ADD_ENUM(VehicleExtraType::LED_HEADLIGHT, "ledHeadlight")
ADD_ENUM(VehicleExtraType::LED_INDICATOR_LEFT, "ledIndicatorLeft")
ADD_ENUM(VehicleExtraType::LED_INDICATOR_RIGHT, "ledIndicatorRight")
ADD_ENUM(VehicleExtraType::LED_SIREN, "ledSiren")
ADD_ENUM(VehicleExtraType::LED_DOOR_OPEN, "ledDoorOpen")
ADD_ENUM(VehicleExtraType::LED_BONNET_OPEN, "ledBonnetOpen")
ADD_ENUM(VehicleExtraType::LED_BOOT_OPEN, "ledBootOpen")
ADD_ENUM(VehicleExtraType::LED_ROOF_OPEN, "ledRoofOpen")
...
IMPLEMENT_ENUM_BEGIN(ResizableVehicleWheelGroup::Enum)
...
IMPLEMENT_ENUM_END("resizable-vehicle-wheel-group")
...
// Sound effects
IMPLEMENT_ENUM_BEGIN(SoundEffectType::Enum)
...
IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Chorus)
ADD_ENUM(SoundEffectParams::Chorus::WET_DRY_MIX, "wetDryMix")
ADD_ENUM(SoundEffectParams::Chorus::DEPTH, "depth")
ADD_ENUM(SoundEffectParams::Chorus::FEEDBACK, "feedback")
ADD_ENUM(SoundEffectParams::Chorus::FREQUENCY, "frequency")
ADD_ENUM(SoundEffectParams::Chorus::WAVEFORM, "waveform")
ADD_ENUM(SoundEffectParams::Chorus::DELAY, "delay")
ADD_ENUM(SoundEffectParams::Chorus::PHASE, "phase")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-chorus")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Compressor)
ADD_ENUM(SoundEffectParams::Compressor::GAIN, "gain")
ADD_ENUM(SoundEffectParams::Compressor::ATTACK, "attack")
ADD_ENUM(SoundEffectParams::Compressor::RELEASE, "release")
ADD_ENUM(SoundEffectParams::Compressor::THRESHOLD, "threshold")
ADD_ENUM(SoundEffectParams::Compressor::RATIO, "ratio")
ADD_ENUM(SoundEffectParams::Compressor::PREDELAY, "predelay")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-compressor")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Distortion)
ADD_ENUM(SoundEffectParams::Distortion::GAIN, "gain")
ADD_ENUM(SoundEffectParams::Distortion::EDGE, "edge")
ADD_ENUM(SoundEffectParams::Distortion::POST_EQ_CENTER_FREQUENCY, "postEQCenterFrequency")
ADD_ENUM(SoundEffectParams::Distortion::POST_EQ_BANDWIDTH, "postEQBandwidth")
ADD_ENUM(SoundEffectParams::Distortion::PRE_LOWPASS_CUTOFF, "preLowpassCutoff")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-distortion")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Echo)
ADD_ENUM(SoundEffectParams::Echo::WET_DRY_MIX, "wetDryMix")
ADD_ENUM(SoundEffectParams::Echo::FEEDBACK, "feedback")
ADD_ENUM(SoundEffectParams::Echo::LEFT_DELAY, "leftDelay")
ADD_ENUM(SoundEffectParams::Echo::RIGHT_DELAY, "rightDelay")
ADD_ENUM(SoundEffectParams::Echo::PAN_DELAY, "panDelay")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-echo")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Flanger)
ADD_ENUM(SoundEffectParams::Flanger::WET_DRY_MIX, "wetDryMix")
ADD_ENUM(SoundEffectParams::Flanger::DEPTH, "depth")
ADD_ENUM(SoundEffectParams::Flanger::FEEDBACK, "feedback")
ADD_ENUM(SoundEffectParams::Flanger::FREQUENCY, "frequency")
ADD_ENUM(SoundEffectParams::Flanger::WAVEFORM, "waveform")
ADD_ENUM(SoundEffectParams::Flanger::DELAY, "delay")
ADD_ENUM(SoundEffectParams::Flanger::PHASE, "phase")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-flanger")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Gargle)
ADD_ENUM(SoundEffectParams::Gargle::RATE_HZ, "rateHz")
ADD_ENUM(SoundEffectParams::Gargle::WAVE_SHAPE, "waveShape")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-gargle")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::I3DL2Reverb)
ADD_ENUM(SoundEffectParams::I3DL2Reverb::ROOM, "room")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::ROOM_HF, "roomHF")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::ROOM_ROLLOFF_FACTOR, "roomRolloffFactor")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::DECAY_TIME, "decayTime")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::DECAY_HF_RATIO, "decayHFRatio")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::REFLECTIONS, "reflections")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::REFLECTIONS_DELAY, "reflectionsDelay")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::REVERB, "reverb")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::REVERB_DELAY, "reverbDelay")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::DIFFUSION, "diffusion")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::DENSITY, "density")
ADD_ENUM(SoundEffectParams::I3DL2Reverb::HF_REFERENCE, "HFReference")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-i3dl2reverb")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::ParamEq)
ADD_ENUM(SoundEffectParams::ParamEq::CENTER, "center")
ADD_ENUM(SoundEffectParams::ParamEq::BANDWIDTH, "bandwidth")
ADD_ENUM(SoundEffectParams::ParamEq::GAIN, "gain")
IMPLEMENT_ENUM_CLASS_END("soundeffect-params-parameq")

IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectParams::Reverb)
ADD_ENUM(SoundEffectParams::Reverb::IN_GAIN, "inGain")
ADD_ENUM(SoundEffectParams::Reverb::REVERB_MIX, "reverbMix")
ADD_ENUM(SoundEffectParams::Reverb::REVERB_TIME, "reverbTime")
ADD_ENUM(SoundEffectParams::Reverb::HIGH_FREQ_RT_RATIO, "highFreqRTRatio")
...
IMPLEMENT_ENUM_BEGIN(FxParticleSystems::Enum)
...
IMPLEMENT_ENUM_BEGIN(WorldProperty::Enum)
...
IMPLEMENT_ENUM_BEGIN(VehicleAudioSettingProperty::Enum)
...
IMPLEMENT_ENUM_END("vehicle-audio-setting")

IMPLEMENT_ENUM_BEGIN(PostFXType::Enum)
...
IMPLEMENT_ENUM_END("postfx-type")
