...
IMPLEMENT_ENUM_CLASS_BEGIN(eNametagProperty)
ADD_ENUM(eNametagProperty::TEXT_FONT, "font")
ADD_ENUM(eNametagProperty::TEXT_BORDER_SHOWING, "borderShowing")
ADD_ENUM(eNametagProperty::TEXT_BORDER_SIZE, "borderSize")
ADD_ENUM(eNametagProperty::COLOR_CODES_ENABLED, "colorCodesEnabled")
ADD_ENUM(eNametagProperty::VISIBLE_TO_SELF, "visibleToSelf")
ADD_ENUM(eNametagProperty::DISTANCE, "distance")
ADD_ENUM(eNametagProperty::DISTANCE_FIXED, "distanceFixed")
ADD_ENUM(eNametagProperty::MIN_DISTANCE, "minDistance")
ADD_ENUM(eNametagProperty::TEXT_SCALE, "textScale")
ADD_ENUM(eNametagProperty::VERTICAL_OFFSET, "verticalOffset")
ADD_ENUM(eNametagProperty::HORIZONTAL_OFFSET, "horizontalOffset")
ADD_ENUM(eNametagProperty::HEALTH_BAR_SHOWING, "healthBarShowing")
ADD_ENUM(eNametagProperty::HEALTH_BAR_COLOR, "healthBarColor")
ADD_ENUM(eNametagProperty::ARMOR_BAR_SHOWING, "armorBarShowing")
ADD_ENUM(eNametagProperty::ARMOR_BAR_COLOR, "armorBarColor")
ADD_ENUM(eNametagProperty::LOCATION, "location")
IMPLEMENT_ENUM_CLASS_END("nametag-property")
