...
public:
    ...
    unsigned char  GetKnockedDownDenials() const { return m_ucKnockedDownDenials; }
    void           SetKnockedDownDenials(unsigned char ucDenials) { m_ucKnockedDownDenials = ucDenials; }
...
private:
    ...
    unsigned char m_ucKnockedDownDenials{0};
