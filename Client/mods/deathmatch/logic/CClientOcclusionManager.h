...
public:
    ...
    // Wraps every occlusion zone the engine already loaded from IPL data as an element;
    // called once from CClientGame::Event_OnIngame, after the native tables are populated.
    void PopulateFromNative();
