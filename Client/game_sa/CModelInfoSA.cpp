...
static const SLightDummyPrefixes g_LightDummyPrefixes[] = {
    ...
    {VehicleExtraType::STROBE_LIGHT, {"strobe_light"}},
    ...
    {VehicleExtraType::STT_LIGHT_LEFT, {"sttlight_L"}},
    {VehicleExtraType::STT_LIGHT_RIGHT, {"sttlight_R"}},
    {VehicleExtraType::NABRAKE_LIGHT_LEFT, {"nabrakelight_L"}},
    {VehicleExtraType::NABRAKE_LIGHT_RIGHT, {"nabrakelight_R"}},
